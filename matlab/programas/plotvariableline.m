function plotvariableline(time,direction,pos,variable,factor)
...
for i = 0:9999
    ...
    if exist(currfile,'file')
        ...
        if (currtime >= time)
            ...
            plot(coords(imin:imax),factor*vrble(imin:imax),'.-k'); hold on
            %semilogy(coords(imin:imax),factor*vrble(imin:imax),'.-k'); hold on
